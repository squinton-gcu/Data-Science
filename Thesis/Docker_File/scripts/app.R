...
plasma_all_stress_graph <- as.data.frame(read.table("application/plasma_all_stress_graph.csv", header=TRUE, sep=","))
plasma_all_stress_pred <- as.data.frame(read.table("application/stress_top_plasma_all_pred.csv", header=TRUE, sep=","))
csf_all_stress_graph <- as.data.frame(read.table("application/csf_all_stress_graph.csv", header=TRUE, sep=","))
csf_all_stress_pred <- as.data.frame(read.table("application/stress_top_csf_all_pred.csv", header=TRUE, sep=","))
