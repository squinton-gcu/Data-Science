...
server <- function(input, output, session) {
  ...
  setwd(location)
  location
  # output$ALZPlasmaN1 <- renderImage({list(src = "/application/application/application/ALZ_plasma _normalized1.png", contentType="image/png", width = 400, height = 400)}, deleteFile = F)
  # output$ALZPlasmaN2 <- renderImage({list(src = "/application/application/application/ALZ_plasma _normalized2.png", contentType="image/png", width = 400, height = 500)}, deleteFile = F)
  # output$ALZPlasmaS1 <- renderImage({list(src = "/application/application/application/ALZ_plasma _scale1.png", contentType="image/png", width = 400, height = 400)}, deleteFile = F)
  # output$ALZPlasmaS2 <- renderImage({list(src = "/application/application/application/ALZ_plasma _scale2.png", contentType="image/png", width = 400, height = 400)}, deleteFile = F)
  ...
  # output$ALZCSFS1 <- renderImage({list(src = "/application/application/application/ALZ_csf _scale1.png", contentType="image/png", width = 400, height = 400)}, deleteFile = F)
  # output$ALZCSFS2 <- renderImage({list(src = "/application/application/application/ALZ_csf _scale2.png", contentType="image/png", width = 400, height = 400)}, deleteFile = F)
  ...
  # output$stressHS1 <- renderImage({list(src = "/application/application/application/trauma_human _scale1.png", contentType="image/png", width = 400, height = 400)}, deleteFile = F)
  # output$stressHS2 <- renderImage({list(src = "/application/application/application/trauma_human _scale1.png", contentType="image/png", width = 400, height = 400)}, deleteFile = F)
